...
function Spider(options) {
    ...
    this.routers = {};
    this.urls = [];
    this.headers = options.defaultHeaders || this.headers;
}
...
Spider.prototype.get = function (url, requestHeaderProvider) {
    ...
    var headerSets = [headers];
    if (requestHeaderProvider) {
        headerSets = requestHeaderProvider(url);
    }
    ...
    headerSets.forEach(function(headerSet) {
        ...
        request.get({url:url, headers:headerSet, pool:self.pool}, function (e, resp) {
