...
exports.replacePlaceholdersWithWildcard = function(path) {
    return replaceVariablePlaceholders(path, '/', ".*");
};
...
exports.determinePathVariableValues = function(path, pathWithPlaceholders) {
    ...
    var pattern = replaceVariablePlaceholders(pathWithPlaceholders, '/', '.*');
...
function replaceVariablePlaceholders(s, separator, substitution) {
    var result = '';
